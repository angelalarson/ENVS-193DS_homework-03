...
This paper is complex and involves many different types of data to address their main research question, however I specifically focused on the use of linear regression to describe the relationship between unit cell volume and ionic composition.
```{r}
#| message: false
